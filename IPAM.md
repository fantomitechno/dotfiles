...
| 15  | ADMIN VPN | `172.16.15.0/24`  | WireGuard               | Internet without restrictions, SSH to servers |
...
| hostname           | address(es)                                          |
| :----------------- | ---------------------------------------------------- |
| OpnSense-DeLoreane | `172.16.10.1/24`, `172.16.15.1/24`, `172.16.20.1/24` |
| CRS309-PortalGun   | `172.16.20.2/24`                                     |
| SG250X-Argo3       | `172.16.20.3/24`                                     |
